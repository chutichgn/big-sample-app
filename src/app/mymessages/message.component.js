...
class MessageController {
    constructor($rootScope, $state, DialogService, Messages) {
    ...
    $onInit() {
        ...
        console.log(2222,this.message)
        this.$rootScope.$broadcast('setTitle', this.message.subject ); // Broadcast title on state entry
...
MessageController.$inject = ['$rootScope','$state', 'DialogService', 'Messages'];
